/* 
	...
	go-iup function names drop the Iup prefix as they are under
	the iup package. go-iup constant names drop the IUP_ prefix
	as they are under the iup package.
